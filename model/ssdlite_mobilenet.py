...
from .mobilenetv3_torch import _make_divisible, load_pretrained_from_timm, mobilenet_v3_large
from .utils import _cxcywh_to_xyxy, _xyxy_to_cxcywh, DefaultBoxGenerator, box_iou, nms
...
class SSDMobile(nn.Module):
    ...
    def multibox_loss(self, cls_logits: torch.Tensor, box_reg: torch.Tensor, targets: List[dict[str, torch.Tensor]], priors: torch.Tensor):
