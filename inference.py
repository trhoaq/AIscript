...
def main() -> None:
    ...
    input_name = get_openvino_input_name(compiled_model)
    img_size = resolve_square_input_size(compiled_model, fallback_img_size)
    ...
    try:
        while True:
            ...
            blob, meta = preprocess_bgr_frame(frame, img_size, return_meta=True)
